...
<?php include "../includes/diebo.php"; ?>
<div class="w3-bottom">
...
echo "<div style='display: inline;'><a href='../".$check_path."posts/book?pid=".$get_post_id."' class=\"username_OF_postLink\">";
        ...
        echo "<div class='emi'><img loading='lazy' src=\"../".$imgs_path."$w_photo_v\" class='eximg $img_sty'><br><p style='margin-left:5px;margin-right'>$get_post_head</p></div>";
		}
		echo "</a></div>";
}

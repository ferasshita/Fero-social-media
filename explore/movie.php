...
echo "<div style='display: inline;'><a href='../".$check_path."posts/film?pid=".$get_post_id."' class=\"username_OF_postLink\">";
        if (!empty($movie)) {
			if(preg_match("/.(ogg|wmb|mp4)$/i", $movie/*importent!!!*/)){
        echo "<div class='emi'><img loading='lazy' src=\"../".$imgs_path."$img_mov\" class='eximg'><br><p style='margin-left:5px;margin-right'>$w_hr</p></div>";
		}}
		echo "</a></div>";
}

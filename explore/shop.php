...
$post_img = $postsfetch['post_img'];
$get_post_time = $postsfetch['post_time'];
$get_post_story = $postsfetch['s_wr'];
$post_content = $postsfetch['post_content'];
...
//shared posts///////////////////////////////////////////////////////////////////////////////
echo "<div style='display: inline;'><a href='../".$check_path."posts/buy?pid=".$get_post_id."' class=\"username_OF_postLink\">";
        if (!empty($pr_buss)) {
        echo "<div class='emi'><img loading='lazy' src=\"../".$imgs_path."$post_img\" class='eximg $img_sty'><br><p style='margin-left:5px;margin-right'>$post_content<br><span style='border:none;color:green;'>$pr_buss LYD</span></p></div>";
		}
		echo "</a></div>";
}

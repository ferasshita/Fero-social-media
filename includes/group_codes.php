...
// =========================== password hashinng ==================================
$signup_password = filter_var(htmlentities($_POST['pd']),FILTER_SANITIZE_STRING);
// ================================================================================
...
if($signup_fullname == null || $signup_username == null || $signup_email == null || $signup_password == null || $signup_cpassword == null){
       ...
       echo "<p>".lang('user_already_exist')."</p>";
        ...
        echo "<p>".lang('email_already_exist')."</p>";
    ...
    $cusers_q_sql = "SELECT id FROM wgroup";
    $cusers_q = $conn->prepare($cusers_q_sql);
    $cusers_q->execute();
    $cusers_q_num_rows = $cusers_q->rowCount();
    if ($cusers_q_num_rows < 1) {
    $signup_admin = "1";   
    $signupsql = "INSERT INTO wgroup (main_id,author_id,gname,bio,email,gphoto,phone,website)
    VALUES( :signup_id, :author_id, :signup_fullname, :signup_username, :signup_email, :userphoto, :signup_password, :signup_cpassword)";
    ...
    $query->bindParam(':signup_cpassword', $signup_cpassword, PDO::PARAM_STR);
    $query->execute(); 
    }else{
    $signupsql = "INSERT INTO wgroup (id,Fullname,Username,Email,Password,Userphoto,gender,language)

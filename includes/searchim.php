...
if(preg_match("/.(png|jpeg|jpg)$/i", $get_post_img/*importent!!!*/) == 0){
...
echo "<div style='display: inline;'><a href='../".$check_path."posts/post?pid=".$get_post_id."' class=\"username_OF_postLink\">";
		...
		echo "<img align='center' class='eximg $img_sty' onclick='lightbox(\"$get_post_id\")' id='lightboxImg_$get_post_id' src=\"../".$imgs_path."$get_post_img\" alt='$query_fetch_fullname' />";

...
.pv{
    ...
    box-sizing: border-box;
	width:46.5%;
	margin-<? echo lang('homeLinks'); ?>:40px;
}
@media screen and (max-width:600px){
.pv{
	width:65%;
	margin-<? echo lang('homeLinks'); ?>:25px;
}}
@media screen and (max-width:600px){
    .te{
        display:none;

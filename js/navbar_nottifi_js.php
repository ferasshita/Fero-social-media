...
var dircheckPath = "<?php echo $dircheckPath; ?>";
if(sbar == ''){
$("#getSearchResulto").hide();
}
else{
$.ajax({
type: "POST",
url: "<?php echo $dircheckPath; ?>includes/searchim.php",
data: {'search_user':sbar,'dircheckPath':dircheckPath},
cache: false,
beforeSend:function(){
    $('#LoadingSearchResult').show();
...
success: function(html){
$('#LoadingSearchResult').hide();
$("#getSearchResulto").html(html).show();
}});
}return false; 
});
$("#searchim").click(function(e){
    $("#search_ro").show();
     e.stopPropagation();
});
$("#search_ro").keyup(function(e){
    e.stopPropagation();
});
// ============================================= search video ===================================================
$(".navbar-inverseo").keyup(function() {
var sbar = $(this).val();
var dircheckPath = "<?php echo $dircheckPath; ?>";
if(sbar == ''){
$("#getSearchResulto").hide();
...
$.ajax({
type: "POST",
url: "<?php echo $dircheckPath; ?>includes/searchvo.php",
data: {'search_user':sbar,'dircheckPath':dircheckPath},
cache: false,
beforeSend:function(){
    $('#LoadingSearchResult').show();
...
// ============================================= search books ===================================================
$(".navbar-inversem").keyup(function() {
var sbar = $(this).val();
var dircheckPath = "<?php echo $dircheckPath; ?>";
if(sbar == ''){
$("#getSearchResulto").hide();
...
$.ajax({
type: "POST",
url: "<?php echo $dircheckPath; ?>includes/searchmo.php",
data: {'search_user':sbar,'dircheckPath':dircheckPath},
cache: false,
beforeSend:function(){
    $('#LoadingSearchResult').show();
...
// ============================================= search music ===================================================
$(".navbar-inversemu").keyup(function() {
var sbar = $(this).val();
var dircheckPath = "<?php echo $dircheckPath; ?>";
if(sbar == ''){
$("#getSearchResulto").hide();
...
$.ajax({
type: "POST",
url: "<?php echo $dircheckPath; ?>includes/searchmu.php",
data: {'search_user':sbar,'dircheckPath':dircheckPath},
cache: false,
beforeSend:function(){
    $('#LoadingSearchResult').show();
...
// ============================================= search conactor ===================================================
$(".navbar-inverseco").keyup(function() {
var sbar = $(this).val();
var dircheckPath = "<?php echo $dircheckPath; ?>";
if(sbar == ''){
$("#getSearchResulto").hide();
...
$.ajax({
type: "POST",
url: "<?php echo $dircheckPath; ?>includes/searchco.php",
data: {'search_user':sbar,'dircheckPath':dircheckPath},
cache: false,
beforeSend:function(){
    $('#LoadingSearchResult').show();

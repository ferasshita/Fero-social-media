...
function lang($txt){
    ...
    'main' => 'الرئيسية',
    'buy_now' => 'أشتري الأن',
    'deliver' => 'توصيل طلابات',
    'accu_ty' => 'نوع الحساب',
    'my_photos' => 'صوري',
    'address' => 'عنوان',
    'Bussiness_discribtion' => 'تفصيل العمل',
    'auto_ans' => 'المجيب الألي',
    'Buy' => 'أشتري',
    'shop' => 'متجر',
    'Vehical_type' => 'نوع المركبه',
    'Bussiness_type' => 'نوع العمل',
    'phone' => 'رقم الهاتف',
    'accept' => 'قبول',
    'wait' => 'أنتاضر',
    'my_posts' => 'منشوراتي',
    ...
    'Menu' => 'قائمه',
    'quiz' => 'أمتحان',
    'Work_free' => 'أعمل بالمجان',
    'poll' => 'تصويت',
    'Telephone/mobile_number' => 'رقم الهاتف',
    'Get_work' => 'أحصل على عمل',
    'Work_detailes' => 'معلمات عن العمل',
    'see_all_notes' => 'رؤية الكل',
    'more' => 'المزيد',
    'Price' => 'السعر',
    'show' => 'أضهر',
    'hide' => 'أخفي',
    'pb_em' => 'أجعل بريدي الالكتروني عام',
    'Chose_background_image' => 'أختر صورة الغلاف',
    'Close_Menu' => 'أغلق القائمة',
    'saved_posts' => 'أحفض المنشور',
    'sign_out' => 'تسجيل خروج',
    'advertisement' => 'الاعلانات',
    'arr' => '28',
    'arrs' => '24',
	'group_name' => 'أسم المجموعه',
    'group_website' => 'صفحه المجموعه',
    'group_phone_number' => 'رقم المجموعه',
    'group_email' => 'بريد الالكتروني للمجموع',
    'descripe_your_group' => 'عرف المجموع',
    'Write_a_topic' => 'أكتب نصآ',
    'create_new_group' => 'أنشاء مجموعه جديدة',
    'Chose_the_font_type' => ' اختر نوع الخط',
    'Chose_the_background_color' => 'أخلر لون التلاف',
    'sid' => ' ',
	'wpost_text' => 'نص',
	'Corona_virus_news' => 'أخبار كرونا',
	'Loction' => 'الموقع',
    'Upload_some_stories' => 'حمل بعض القصص',
    'Saved_stories' => 'القصص المحفوضة',
    'Mention' => 'Mention',
    'Time' => 'الوقت',
    'storyo' => 'قصتي',
    'Stories' => 'القصص',
    'email_policy' => 'سوف نستعمل بريدك الالكتروني و رقم الموبايل للتواصل معك. سوف يكون خاص لا أحد يمكنة أن يعرفه',
    'Click_on_emoji_icon_to_display_the_pictures' => 'أضغط على الإموجي لأضهار الصور',
    'Share_the_saved_stories' => 'شارك بالقصص المحفوضة',
    'wpost_photo_pdf' => 'بيديأف/فيديو/أغاني/صور',
    ...
    'w_post_dir' => 'rtl',
    'w_post_move' => 'right',
	'link_DDM' => 'رابط لهدة المنشور',
    'embed_DDM' => 'وضع هدة المنشور (embed)',
    ...
    'save' => 'حفظ',
    'cancel' => 'الغاء',
    'Upload_some_Posts' => 'أنشر بعض المنشورات',
    ...
    'story' => 'روايه',
    'smart_text' => 'أكتب نص للزر',
    'location' => 'موقع',
    'Payment_methods' => 'طرق الدفع',
    'smart_link' => 'أكتب الرابط للزر الدكي',
    'link' => 'رابط',
    'postSavedBefore' => 'لقد قمت مسبقا بحفظ هذا المنشور!',
    'Write_the_story' => 'أكتب القصه',
    ...
    'write_a_header_to_your_story' => 'أكتب عنوان للقصه',
    'Write_the_link_for_that_website' => 'أكتب الرابط لدالك الموقع',
    'hint_youtube' => 'يمكنك اضافة رابض لفيديو يوتيوب, منشور فاسبوك او أي موقع',
    'totalPhotos' => 'مجموع المنشورات',
    'see_all' => 'رؤية الكل',
   ...
   'verify_badge_removed_succ_from' => 'تم ازالة علامة التوثيق من',
    ...
    'images' => 'صور',
    'Books' => 'كتب',
    'input_word' => 'كلمة الأدخال',
    'output_word' => 'كلمة الأخراج',
    'Answer_questions' => 'أجوبة الأسأله',
    'stmrbt' => 'أزرار دكيه',
    'videos' => 'فيديوات',
    'story_image_video' => 'صور\ فيديوات\ أغاني',
    'musics' => 'أغاني',
    'Movies' => 'أفلام',
    'Your_contacts' => 'جهات الاتصال',
    'Skip' => 'تخطي',
    'delete_me' => 'أحدف الرساله فقط مني',
    'msg_delete' => 'أحدف الرساله',
    'Write_your_message' => 'أكتب رسالة',
    'No_followers_yet' => 'لم تتابع أحد',
    'Follow_any_one' => 'تابع اي شخص',
    'Previous' => 'السابق',

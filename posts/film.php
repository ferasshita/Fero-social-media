...
<head>
    <title>Movie &bull; Fero</title>
    <meta charset="UTF-8">
	<meta name="description" content="-you can watch your friends movie only on fero- you can easly watch, edit, save, like, comment & download your freinds movies.">
    <meta name="keywords" content="fero, fero account, movie, feras shita">
...
.fla{
	width: 1250px;height:600px;min-width: 1250px;max-height:600px;
}
...
@media screen and (max-width:600px){
	.fla{
		width: 100%;height:600px;min-width: 100%;max-height:600px;
	}
	.posti{
	width:100%;
	min-width:100%;
...
<div class="w3-main" align="<?php echo lang('w_post_align'); ?>" style="margin-<?php echo lang('w_post_align'); ?>:0px;margin-top:43px;text-align:<?php echo lang('w_post_align'); ?>;direction: <?php echo lang('w_post_dir'); ?>">
...
$get_post_head = $postsfetch['hea_wrm'];
...
//shared posts///////////////////////////////////////////////////////////////////////////////
	...
	//edit/////////////////////////////////////////
    echo "</div>
    <div class=\"posti\" style='text-align:".lang('post_content_align').";'>
    ...
    "; 
	echo "    <div id='postNotify_$get_post_id'></div>
	...
	echo"<div style='min-width:100%;'><h1 align='center'>$get_post_head</h1>";
	if(!empty($movie)){
		if(preg_match("/.(mp4|ogg|wbm)$/i", $movie/*importent!!!*/)){
echo "<video controls autoplay align='center' style='width: 100%;height:600px;min-width: 100%;max-height:600px;border-radius:10px;object-fit:cover;' id='lightboxImg_$get_post_id' src='../imgs/$movie'></video>";
	}elseif(preg_match("/.(mp3|ogg|wav)$/i", $movie/*importent!!!*/)){
		echo"<img src='../imgs/$img_mov' align='center' style='width: 100%;height:600px;min-width: 100%;max-height:600px;border-radius:10px;'><audio controls autoplay align='center' style='width: 100%;height:80px;min-width: 100%;max-height:80px;' id='lightboxImg_$get_post_id' src='../imgs/$movie'></audio>";
		}else{
			echo"<embed type='application/pdf' align='center' class='fla' style='border-radius:10px;' id='lightboxImg_$get_post_id' src='../imgs/$movie'></embed>";
		}
	}
...
while ($sharedRow = $fetch_shared->fetch(PDO::FETCH_ASSOC)) {
	...
	$get_post_head = $sharedRow['hea_wrm'];
...
echo"<div style='max-width:100%;'><h1 align='center'>$get_post_head</h1>";
	if(!empty($movie)){
		if(preg_match("/.(mp4|ogg|wbm)$/i", $movie/*importent!!!*/)){
echo "<video controls autoplay align='center' style='width: 100%;height:600px;max-width: 100%;max-height:600px;' id='lightboxImg_$get_post_id' src='../imgs/$movie'></video>";
	}elseif(preg_match("/.(mp3|ogg|wav)$/i", $movie/*importent!!!*/)){
		echo"<img src='../imgs/$img_mov' align='center' style='width: 100%;height:600px;max-width: 100%;max-height:600px;'><audio controls autoplay align='center' style='width: 1250px;height:80px;min-width: 1250px;max-height:80px;' id='lightboxImg_$get_post_id' src='../imgs/$movie'></audio>";
		}else{
			echo"<embed type='application/pdf' align='center' style='width: 1250px;height:600px;min-width: 1250px;max-height:600px;' id='lightboxImg_$get_post_id' src='../imgs/$movie'></embed>";
		}
	}
		echo"</div>";}
// ===================tools==================
$user_prof = $_SESSION['Username'];
echo "
<div id='postNotify2_$get_post_id'></div>
<div>
<div class='w3-bottom'>
<nav class='w3-sidebar w3-bottom w3-right w3-overflow-x w3-light-grey w3-animate-bottom' style='z-index:3;box-shadow: 0px 0px 5px black;width:70px;height:250px;border-radius:10%;display:none;float:right;' id='mySidebar'><br>&nbsp;&nbsp;&nbsp;&nbsp;";
//like
$s_id = $_SESSION['id'];
...
$c_num = $c->rowCount();
if ($c_num > 0){
    echo "<span id='likeUnlike_$get_post_id' style='cursor:pointer'><span onclick=\"likeUnlike('$get_post_id')\" class='w3-button' style='color:#ff928a;font-size:25px' data-toggle='tooltip' data-placement='top' title='".lang('u_liked_this')."' id='punlike'><span class=\"fa fa-heart\"></span></span></span>";
}else{
    echo "<span id='likeUnlike_$get_post_id' style='cursor:pointer'><span onclick=\"likeUnlike('$get_post_id')\" class='w3-button' style='color:#ff928a;font-size:25px' data-toggle='tooltip' data-placement='top' title='".lang('liked')."' id='plike'><span class=\"fa fa-heart-o\"></span></span></span>";
}
...
echo"<a href='javascript:void(0);' style='font-size:25px' onclick=\"sharePost('$get_post_id','$check_path')\" class='post_like_comment_shareA w3-button' data-toggle='tooltip' data-placement='top' title='".lang('share_now')."'><span class=\"fa fa-share\"></span></a>
<a href=\"javascript:void(0);\"onclick=\"dis('d_$get_post_id')\" style='font-size:25px' class='post_like_comment_shareA w3-button' data-toggle='tooltip' data-placement='top' title='".lang('comment')."'><span onclick=\"fcomment('$get_post_id')\" class=\"fa fa-commenting\"></span></a>
<a href='../imgs/$movie' download style='font-size:25px' class='post_like_comment_shareA w3-button' data-toggle='tooltip' data-placement='top' title='download'><span class=\"fa fa-download\"></span></a>
<a href='javascript:void(0)' class='w3-button' onClick='w3_close()' title='close menu'><i class='fa fa-remove fa-fw'></i></a>
</nav>
<div class='w3-bar w3-white w3-large'>
<a href='../u/$user_prof' class='w3-bar-item w3-button w3-right' target='_self' title='profile'><i class='fa fa-user'></i></a>
<a href='../u/$user_prof' class='w3-bar-item w3-button w3-right' target='_self' title='profile'><i class='fa fa-user'></i></a>
<a href='../search' class='w3-bar-item w3-button w3-right' target='_self' title='search'><i class='fa fa-search'></i></a>
<a href='../post' class='w3-bar-item w3-button w3-right' target='_self' title='add an image'><i class='fa fa-upload'></i></a>
<a href='../explore' class='w3-bar-item w3-button w3-right' target='_self' title='explore'><i class='fa fa-heart'></i></a>
<a href='../home' class='w3-bar-item w3-button w3-right' target='_self' title='home'><i class='fa fa-home'></i></a>
<a href='javascript:void(0)' onClick='w3_open();' class='w3-bar-item w3-button' target='_self' title='menu'><i class='fa fa-bars'></i></a>
</div>
</div>";
...
<span></span>
<div class='loader '>
<div onclick=\"dis('d_$get_post_id')\">
<br>
<br>
<div style='color:white;' class='user_comment' id='postComments_$get_post_id'>";
    include "../includes/fetch_comments.php";
echo"</div></div>	<div id='writeComm_$get_post_id' class='w3-bottom'>
